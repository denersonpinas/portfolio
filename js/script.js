var linkProjetos = [
    {
        ...
        linkImg: "https://firebasestorage.googleapis.com/v0/b/wsremoto-1193d.appspot.com/o/smartmockups_ktx8gpup.jpg?alt=media&token=3d356564-0498-4ff0-8867-e0218497b280",
        span: "2021 - Atual",
        title: "Projeto AluraFlix",
        subTitle: "Front-end",
        resumo: "Projeto produziodo para conclusão de desafio proposto pelo grupo alura, em seu evento #imersaodev, o projeto tinha foco em inicialização de dev no mercado de programação e as linguagens propostas era HTML, CSS e JS com foco em JavaScrip. Este desafio tinha como objetivo mostrar a utilização de arrays e laço de repetiçao com JS.",
        like: 0
    },
    {
        linkProjeto: "https://codepen.io/denersonpinas/full/gORKpMW",
        linkImg: "https://firebasestorage.googleapis.com/v0/b/wsremoto-1193d.appspot.com/o/smartmockups_ktx8i27z.jpg?alt=media&token=546c7dca-74bc-4da6-a6bc-121bbbbb1567",
        span: "2021 - Atual",
    ...
    },
    {
        ...
        linkImg: "https://firebasestorage.googleapis.com/v0/b/wsremoto-1193d.appspot.com/o/smartmockups_ktx8iy5e.jpg?alt=media&token=b6ad8360-d184-486c-a711-e0bc07e8e32b",
        span: "2021 - Atual",
    ...
    },
    {
        ...
        linkImg: "https://firebasestorage.googleapis.com/v0/b/wsremoto-1193d.appspot.com/o/smartmockups_ktx8juur.jpg?alt=media&token=dd4328e9-f416-4556-b247-bf94cd6e4ff2",
        span: "2021 - Atual",
...
function controlePage(param) {
    var elementSobre = document.getElementById("sobre")
    var elementSkills = document.getElementById("skills")
    if (param == "sobre") {
        elementSkills.style.display = "none"
        elementSobre.style.display = "block"
    } else if(param =="skills") {
        elementSkills.style.display = "block"
        elementSobre.style.display = "none"
    }
}